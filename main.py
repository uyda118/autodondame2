...
stdout.write("                   TOOL GỐC: HASOKI ")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Zalo: 09xx.xxx.xxx   "+Fore.LIGHTGREEN_EX  +"          ║\n")
...
def command():
    ...
    if command == "cls" or command == "clear":
        ...
        timer.start()
        timer.join()        
 elif command == "atn" or command == "adn":
        target, port, thread, t = get_info_l4()
        threading.Thread(target=runvse, args=(target, port, t, thread)).start()
...
def func():
 ...
 stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"adn     "+Fore.RED+": "+Fore.WHITE+"AUTO DỒN DAME\n")
